...
def main():
   ...
   <center><p style="font-size:25px;color:white;margin-top:10px;"Machine Learning project-5</p></center> 
   </div>
   </div>
   </div>
   """
    ...
    if st.button("About"):
      st.header("Developed by Hemraj Kumawat")
      st.subheader(" Software Engineer")
    html_temp = """
    <div class="" style="background-color:orange;" >
    <div class="clearfix">           
    <div class="col-md-12">
    <center><p style="font-size:20px;color:white;margin-top:10px;">Machine Learning Experiment SVM: Support Vector Machine and Random Forest</p></center> 
    </div>
    </div>
    </div>
    """
